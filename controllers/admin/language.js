...
Router.get('/listLanguages',verifyToken, function(req,res) {
  const response = {
    status  : 0,
  }
...
Router.post('/viewLanguages',verifyToken,function(req,res) {
  const response = {
...
Router.post('/addUpdateLanguages',verifyToken,function(req,res) {
  const response = {
    status  : 0,
